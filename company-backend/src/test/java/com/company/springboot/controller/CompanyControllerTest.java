...
public class CompanyControllerTest {
    ...
    public void testGetCompanyByName() throws Exception {
        ...
        company.setCompCeo("Comp Ceo");
        company.setDate("2020-03-01");
        when(this.iCompanyService.getCompanyByName(anyString())).thenReturn(company);
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/company/get_company_name/{comp_name}",
                "Comp name");
        MockMvcBuilders.standaloneSetup(this.companyController)
                .build()
                .perform(requestBuilder)
